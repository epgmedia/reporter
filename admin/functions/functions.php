...
function generate_options_css($newdata) {
	...
	update_option( 'reporter-options', $css );

	/**
	 * Deprecated.
	 *
	 * Theme should not write to stylesheet. Styles should be stored in theme options to
	 * prevent issues with multisite themes.
	 *
	 * Theme should now save options to option. Options are then enqueued in the head, and
	 * output directly for each theme.
	 */
	/*WP_Filesystem();
...
/** Prints out the reporter options */
